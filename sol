...
contract Technoland is IERC20 {
    ...
    string constant private _name = "Technoland";
    string constant private _symbol = "TECHNO";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x4B0a938D68B4bf411C382aa223d696a0F99B5851)
    });
